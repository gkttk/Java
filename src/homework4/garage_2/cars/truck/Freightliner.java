...
public class Freightliner extends ATrucks {
    private final String id = "Freightliner(Truck)";
    private String model;



    public Freightliner(String model, double maxTanks, IEngine engine, IWheels wheels, ILock lock) {
